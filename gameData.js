module.exports = [
	...
	},
	{
		...
		header: "You should have received an invitation to these already - if this hasn’t happened then contact Phill Coxon at foundation@enspiral.com).",
		challenges: [
			{	
				id: 1,
				title: "Join loomio",
